...
// Pratheesh Prakash // it has ULN2003 IC on the pins connected to the play pause and prev buttons etc
#include <EEPROM.h>

int temp;
unsigned long first_song_length  = 3000;
unsigned long second_song_length = 3000;
unsigned long third_song_length  = 3000;
...
void setup()
{
  ...
  pinMode(13,OUTPUT);// power for RC receiver
